// In this example, we learn how to handle file and practice some string
// operations. We write a game called jumble for this purpose.
#include <ctype.h>
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
int choose_k(int count) { return rand() % count; }
